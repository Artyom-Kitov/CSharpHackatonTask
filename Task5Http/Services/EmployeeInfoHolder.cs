...
{
    public class EmployeeInfoHolder(AppType type, int id)
    {
        ...
        private static string GetName(AppType type, int id)
        {
            string path = type == AppType.Junior ? JuniorsPath : TeamleadsPath;
